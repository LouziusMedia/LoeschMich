...
Analyse (JSON):"""
    ...
    def _keyword_analyze(self, response_text: str) -> Dict[str, Any]:
        ...
        completion_keywords = ['gelöscht', 'deleted', 'entfernt', 'removed', 
                              'vollständig gelöscht', 'completely deleted']
        ...
        ack_keywords = ['bestätigen', 'erhalten', 'bearbeiten', 'prüfen',
                       'acknowledge', 'received', 'processing']
        ...
        # Check for rejection
        rejection_keywords = [
            'ablehnen', 'abgelehnt', 'nicht möglich', 'nicht erfüllen',
            'reject', 'rejected', 'cannot', 'can not', 'unable',
            'gesetzliche aufbewahrungspflicht', 'gesetzlichen aufbewahrungspflichten',
            'aufbewahrungspflicht', 'aufbewahrungspflichten',
            'legal obligation', 'legal obligations', 'retention obligation', 'retention obligations'
        ]
        ...
        info_keywords = ['weitere informationen', 'more information', 'identifizierung',
                        'identification', 'nachweis', 'proof']
