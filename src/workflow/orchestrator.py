...
from ..core.models import GDPRRequest, RequestStatus, Company, WorkflowTask
...
class WorkflowOrchestrator:
    ...
    def create_and_send_request(self,
                               company: Company,
                               ...
                               language: str = "de",
                               auto_send: bool = False) -> Optional[int]:
        """
    ...
    def process_response(self, request_id: int, response_text: str) -> Dict[str, Any]:
        ...
        self.db.update_request_status(
            request_id,
            new_status,
            notes=f"Response analyzed: {analysis['summary']}"
        )
